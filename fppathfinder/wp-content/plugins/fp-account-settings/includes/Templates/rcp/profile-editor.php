...
if ( is_user_logged_in() ):
	...
	$all_fields_show    = true;
	$first_name_show    = true;
	$last_name_show     = true;
	$display_name_show  = true;
	$email_address_show = true;

	do_action( 'rcp_profile_editor_messages', $current_user );
	rcp_show_error_messages(); ?>
	<form id="rcp_profile_editor_form" class="rcp_form" action="<?php echo rcp_get_current_url(); ?>/#profile" method="post">
		<fieldset>
