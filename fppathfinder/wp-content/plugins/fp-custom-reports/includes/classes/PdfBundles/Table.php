 ...
 * @subpackage Custom_Reports/Includes/Classes/PdfBundles
 * @author     Objectiv
...
namespace CustomReports\PdfBundles;
...
class Table extends \WP_List_Table {
	 ...
	 * @var string
	 */
	protected $slug = 'pdf-bundles-report';
	...
	public function __construct() {
		parent::__construct(
			array(
				'singular' => __( 'PDF Bundles Downloads Report', ' custom-reports' ),
				'plural'   => __( 'PDF Bundles Downloads Reports', ' custom-reports' ),
				'ajax'     => false,
			)
		);
	}
